...
class ApplicationDeviceService
{
    ...
    public function add($applicationId, $deviceId, $idfa, $appsflyerUniqueId, $location)
    {
    ...
    public function update($applicationId, $deviceId, $idfa, $appsflyerUniqueId, $location)
    {
